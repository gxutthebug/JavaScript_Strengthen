// 像Obeject.create()这种静态方法究竟是怎么挂载上去的呢？
...
/*
   总结：
    ①定义静态属性只能先声明好构造函数,然后在外部通过  构造函数名.属性/方法名 的形式添加
    ②静态属性不能通过对象实例访问 , 能且只能通过 构造函数名.属性/方法名 直接访问
    ③JS的构造函数 () { } 本质就是一个原原本本的constructor()构造器;所以构造函数 () {} 内定义的所有属性必须加this.修饰
    ④像在JAVA中非构造器部分的属性继承,js中由原型对象完成
